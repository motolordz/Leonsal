...
try {
  ...
  await fs.writeFile(`${out}/results.json`, JSON.stringify({ passed: true, viewports: [390, 768, 1280], checks: ['hub loaded', 'five world cards', 'ten sensory games', 'five learning engine cards', 'settings popover', 'no horizontal overflow', 'no review-art requests'], errors }, null, 2) + '\n');
