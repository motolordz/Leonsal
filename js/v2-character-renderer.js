...
(() => {
  ...
  const emotions = {
    empty: { eye: 'closed', mouth: 'sleep', lean: -5, lift: 8, arm: 'rest' },
    low: { eye: 'tired', mouth: 'soft', lean: -2, lift: 4, arm: 'rest' },
    calm: { eye: 'open', mouth: 'smile', lean: 0, lift: 0, arm: 'ready' },
    happy: { eye: 'open', mouth: 'happy', lean: 3, lift: -4, arm: 'wave' },
    excited: { eye: 'bright', mouth: 'excited', lean: 5, lift: -8, arm: 'celebrate' }
  };
